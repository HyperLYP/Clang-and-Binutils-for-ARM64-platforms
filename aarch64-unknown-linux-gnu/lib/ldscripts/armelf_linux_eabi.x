...
OUTPUT_ARCH(arm)
ENTRY(_start)
SEARCH_DIR("/home/HyperLYP/tc-build/install/aarch64-unknown-linux-gnu/lib"); SEARCH_DIR("/home/HyperLYP/tc-build/install/lib"); SEARCH_DIR("/usr/local/lib"); SEARCH_DIR("/lib"); SEARCH_DIR("/usr/lib");
SECTIONS
{
